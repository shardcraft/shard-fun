...
execute as @a[tag=replace_soul_axe] run function shard_fun:soul_tools/give/soul_axe
...
execute as @a[tag=replace_soul_hoe] run function shard_fun:soul_tools/give/soul_hoe
...
execute as @a[tag=replace_soul_pickaxe] run function shard_fun:soul_tools/give/soul_pickaxe
...
execute as @a[tag=replace_soul_shovel] run function shard_fun:soul_tools/give/soul_shovel
